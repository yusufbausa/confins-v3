...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Approval/button_menu_appraisal_approval'), 20)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Approval/button_menu_appraisal_approval'))
WebUI.delay(1)


//input cust credential
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Approval/field_agreement_number'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Approval/button_process_approval_data'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Approval/select_action'), 20)
