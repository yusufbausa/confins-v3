...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/button_menu'), 20)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/button_menu'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_inventory_management_menu'), 20)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_inventory_management_menu'), 
    '402', false)
WebUI.delay(1)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/search_market_price'), 20)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/search_market_price'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_office_name'), 20)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_office_name'), 
    '218', false)
WebUI.delay(1)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/button_search_office_name'))
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_asset'), 20)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_asset'))
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/search_deduction'), 20)
WebUI.click(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/search_deduction'))
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_deduction_item'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_deduction_item'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_min_selling_amount'), 20)
WebUI.scrollToElement(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_min_selling_amount'), 0)
WebUI.delay(1)
WebUI.sendKeys(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_min_selling_amount'),
	Keys.chord(Keys.CONTROL + "a"))
WebUI.sendKeys(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_min_selling_amount'),
Keys.chord(Keys.DELETE))
WebUI.sendKeys(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_min_selling_amount'), 
    minSelling)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_reason_description'), 
    '461', false)
WebUI.delay(1)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/select_approve_by'), 
    approvedBy, false)
WebUI.delay(1)
WebUI.setText(findTestObject('COLLECTION/Asset Appraisal/Asset Appraisal Req/field_approval_notes'), 
    notes)
WebUI.delay(1)
