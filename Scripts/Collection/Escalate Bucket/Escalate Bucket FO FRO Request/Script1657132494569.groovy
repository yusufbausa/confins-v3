...
//select role
WebUI.click(findTestObject('Object Repository/COLLECTION/Escalate Bucket/Escalate Bucket DERO Request/select_ar_head_fo_role'))
WebUI.delay(1)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/COLLECTION/Escalate Bucket/Escalate Bucket DERO Request/select_coll_bucket_destination'),
	collBucketDestination, false)
WebUI.delay(1)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/COLLECTION/Escalate Bucket/Escalate Bucket DERO Request/select_approved_by'), 
    approvedBy, false)
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/COLLECTION/Escalate Bucket/Escalate Bucket DERO Request/field_notes'), notes)
WebUI.delay(1)
