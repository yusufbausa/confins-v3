...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Approval/button_menu_expected_date_approval'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Approval/field_agreement_number'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Approval/button_edit_data'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Approval/select_action'), 20)
