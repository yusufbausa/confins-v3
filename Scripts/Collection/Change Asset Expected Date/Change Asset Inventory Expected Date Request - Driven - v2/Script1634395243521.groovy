...
WebUI.selectOptionByLabel(findTestObject('COLLECTION/Change Asset Expected Date/Expected Date Req/select_reason_description'), 'NEGOSIASI DENGAN CUSTOMER', false)
