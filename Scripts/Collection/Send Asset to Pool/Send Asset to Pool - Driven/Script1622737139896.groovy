...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/button_menu'), 20)
WebUI.click(findTestObject('COLLECTION/Send Asset to Pool/button_menu'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/select_inventory_management_menu'), 20)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Send Asset to Pool/select_inventory_management_menu'), 
    '402', false)
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/expand_menu_send_asset'), 20)
WebUI.click(findTestObject('COLLECTION/Send Asset to Pool/expand_menu_send_asset'))
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/button_menu_send_asset_to_pool'), 20)
WebUI.click(findTestObject('COLLECTION/Send Asset to Pool/button_menu_send_asset_to_pool'))
WebUI.delay(1)


//input cust credential
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/select_collection_group'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/button_edit_data'), 20)
WebUI.click(findTestObject('COLLECTION/Send Asset to Pool/button_edit_data'))
WebUI.delay(1)


//send asset to pool process
WebUI.waitForElementPresent(findTestObject('COLLECTION/Send Asset to Pool/select_pool'), 20)
