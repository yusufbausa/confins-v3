...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/button_menu'), 20)
WebUI.click(findTestObject('COLLECTION/Confirm Repossess/button_menu'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/select_menu_collection'), 20)
WebUI.selectOptionByValue(findTestObject('COLLECTION/Confirm Repossess/select_menu_collection'), 
    '270', false)
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/extend_menu_repossess'), 20)
WebUI.click(findTestObject('COLLECTION/Confirm Repossess/extend_menu_repossess'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/button_menu_repossess'), 20)
WebUI.click(findTestObject('COLLECTION/Confirm Repossess/button_menu_repossess'))
WebUI.delay(1)


//input cust credential (agreement no)
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/field_agreement_no'), 20)
...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/button_edit_collection_data'), 20)
WebUI.click(findTestObject('COLLECTION/Confirm Repossess/button_edit_collection_data'))
WebUI.delay(1)


//confirm repossess process
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/field_repossess_date'), 20)
...
//asset checklist
WebUI.waitForElementPresent(findTestObject('COLLECTION/Confirm Repossess/radio_check_ac'), 20)
