...
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('Credit Review/Credit Review Company/additional/btn_menu_credit_review'), 20)
...
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_app_number'), appNo)
...
WebUI.delay(1)
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_latar_belakang_debitur'), statements)
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_faktor2_mendukung'), statements)
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_faktor2_tidak_mendukung'), statements)
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_syarat2'), statements)
WebUI.setText(findTestObject('Credit Review/Credit Review Company/field_CA_calculation'), statements)
