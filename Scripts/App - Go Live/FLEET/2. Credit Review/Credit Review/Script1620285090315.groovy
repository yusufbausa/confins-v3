...
WebUI.setText(findTestObject('Login/username'), 'ELU0538')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/FLEET/Credit Review/select_Select OneELU0538PWS1447'), '292206', 
    false)
WebUI.setText(findTestObject('Object Repository/FLEET/Credit Review/textarea_Notes_ucApvtxtNotes'), 'Approved')
