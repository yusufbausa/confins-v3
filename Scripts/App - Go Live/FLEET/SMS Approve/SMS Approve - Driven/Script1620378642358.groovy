...
WebUI.waitForElementPresent(findTestObject('Object Repository/FLEET/SMS Approve/img_Welcome, applconfins_imgMenu'), 20)
WebUI.click(findTestObject('Object Repository/FLEET/SMS Approve/img_Welcome, applconfins_imgMenu'))
WebUI.waitForElementPresent(findTestObject('Object Repository/FLEET/SMS Approve/a_Task Monitoring'), 20)
WebUI.click(findTestObject('Object Repository/FLEET/SMS Approve/a_Task Monitoring'))
WebUI.delay(1)


//INPUT CUST CREDENTIAL============================================================================================================================================
WebUI.waitForElementPresent(findTestObject('Object Repository/FLEET/SMS Approve/input_Transaction No._ucSearchtxtTransactionCode_ltlWfTaskListsTransactionCode'), 20)
WebUI.setText(findTestObject('Object Repository/FLEET/SMS Approve/input_Transaction No._ucSearchtxtTransactionCode_ltlWfTaskListsTransactionCode'), 
    appNo)
WebUI.click(findTestObject('Object Repository/FLEET/SMS Approve/input_Instance GUID_ucSearchbtnSearch'))
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('Object Repository/FLEET/SMS Approve/input_SYSTEM_gvUserTaskctl02lb_ResumeTask'), 20)
WebUI.click(findTestObject('Object Repository/FLEET/SMS Approve/input_SYSTEM_gvUserTaskctl02lb_ResumeTask'))
WebUI.delay(1)


//RESUME WORKFLOW============================================================================================================================================
WebUI.waitForElementPresent(findTestObject('Object Repository/FLEET/SMS Approve/a_Resume'), 20)
