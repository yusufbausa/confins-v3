...
WebUI.setText(findTestObject('New Application (NEW)/Asset Data/field_no_mesin'), 'L15776305696')
WebUI.setText(findTestObject('New Application (NEW)/Asset Data/field_no_rangka'), 'MHRGK7660GJ703896')
