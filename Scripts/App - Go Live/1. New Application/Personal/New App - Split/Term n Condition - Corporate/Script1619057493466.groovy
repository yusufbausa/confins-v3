...
WebUI.setText(findTestObject('Object Repository/New Application (NEW)/Term n Condition - Corporate/input_Copyright  AdIns 2011. All Right Rese_f32c18'), 
    'ABW0572')
WebUI.setEncryptedText(findTestObject('Object Repository/New Application (NEW)/Term n Condition - Corporate/input_Copyright  AdIns 2011. All Right Rese_9b6a71'), 
    '8SQVv/p9jVScEs4/2CZsLw==')
WebUI.click(findTestObject('Object Repository/New Application (NEW)/Term n Condition - Corporate/a_Select'))
...
WebUI.click(findTestObject('Object Repository/New Application (NEW)/Term n Condition - Corporate/input_-_lb_Form_Save'))
