...
//ADD GUARARNTOR
//WebUI.waitForElementPresent(findTestObject(''), 20)
...
WebUI.selectOptionByValue(findTestObject('New Application (NEW)/Guarantor/Page_New Confins 1 - Main/select_customer_relationship'),
	'GUARANTOR', false)
WebUI.delay(5)
WebUI.waitForElementPresent(findTestObject('New Application (NEW)/Guarantor/Page_New Confins 1 - Main/button_save_guarantor'), 20)
WebUI.verifyElementPresent(findTestObject('New Application (NEW)/Guarantor/Page_New Confins 1 - Main/button_save_guarantor'), 2)
...
WebUI.selectOptionByValue(findTestObject('New Application (NEW)/Asset Data/select_sales'), 
    '47763', false)
WebUI.waitForElementPresent(findTestObject('New Application (NEW)/Asset Data/image_select_asset_name'), 20)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/New Application (NEW)/Asset Data - Multi/input_ARMADA AUTO TARA - TGR CIKOKOL 1_gvAs_fab4de'), 20)
...
//INSURANCE ASSET 2====================================================================================================================================================================================
WebUI.waitForElementPresent(findTestObject('Object Repository/New Application (NEW)/Insurance Data - Multi/input_TOYOTA AVANZA 1.3 E MT_gvEntryInsctl0_08bdfe'), 20)
