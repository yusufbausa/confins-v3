...
WebUI.delay(2)
WebUI.scrollToElement(findTestObject('Object Repository/SIAP DANA/Term n Condition Corporate Siap Dana/input_No_gvTermConditionctl14cbChecked'), 0)
...
WebUI.delay(2)
WebUI.scrollToElement(findTestObject('Object Repository/SIAP DANA/Term n Condition Corporate Siap Dana/input_-_lb_Form_Save'), 0)
