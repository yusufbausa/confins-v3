...
//SELECT CUSTOMER-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
WebUI.waitForElementPresent(findTestObject('Object Repository/New Application (NEW)/New Application - Customer/input_Personal_rblCustType'), 20)
...
//asset registration
WebUI.waitForElementPresent(findTestObject('New Application (NEW)/Asset Data/input_HJAasd79843946148648_gvAssetListctl02imbEdit_2'), 20)
...
//insurance asset 2
WebUI.waitForElementPresent(findTestObject('New Application (NEW)/Insurance Data/input_E 8723 IKI_gvEntryInsctl02imbEdit_2'), 20)
...
//ADD TERM & CONDITION---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
WebUI.waitForElementPresent(findTestObject('Object Repository/New Application (NEW)/Term n Condition - Corporate/input_Yes_gvTermConditionctl02cbChecked'), 20)
