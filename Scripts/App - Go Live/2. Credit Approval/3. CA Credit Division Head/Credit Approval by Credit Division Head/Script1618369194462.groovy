...
WebUI.scrollToElement(findTestObject('Object Repository/Credit Approval/Credit Approval by Credit Division Head/input_Customer Income_ucCustIncometxtInput'), 
    2)
...
WebUI.delay(1)
WebUI.scrollToElement(findTestObject('Object Repository/Credit Approval/Credit Approval by Credit Division Head/select_Select OneApproveRejectRequest'),
	2)
