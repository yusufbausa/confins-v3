...
WebUI.waitForElementPresent(findTestObject('Object Repository/Asset Document/Release/Release Doc Checkout/img_Welcome, FANNY HUMAIRAH, TANGERANG, BPK_67220f'), 20)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Asset Document/Release/Release Doc Checkout/input_Agreement No_ucSearchtxtAgrmntNo_ltlAgrmntAgrmntNo'), 20)
WebUI.setText(findTestObject('Object Repository/Asset Document/Release/Release Doc Checkout/input_Agreement No_ucSearchtxtAgrmntNo_ltlAgrmntAgrmntNo'), 
    agreeNo)
WebUI.selectOptionByValue(findTestObject('Object Repository/Asset Document/Release/Release Doc Checkout/select_Select OneAsset DocumentAddColl Document'), 
    'ASD', false)
...
WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('Object Repository/Asset Document/Release/Release Doc Checkout/input_Release_gvRequestListctl02imbEdit'), 20)
