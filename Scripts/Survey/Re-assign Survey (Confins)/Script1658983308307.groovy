...
//reassign process
//survey 1
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_reassign1'))
WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/img_search_surveyor_name'))
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/Survey/Survey Reassign/field_surveyor_name'), 
    surveyorName)
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_search_surveyor'))
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_select_surveyor'))
WebUI.delay(1)
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_submit'))
WebUI.delay(1)


//survey 2
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_reassign2'))
WebUI.delay(1)
...
//submit
WebUI.click(findTestObject('Object Repository/Survey/Survey Reassign/btn_save_reassign'))
WebUI.delay(5)
