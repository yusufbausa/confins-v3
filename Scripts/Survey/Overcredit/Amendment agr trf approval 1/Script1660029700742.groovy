...
WebUI.setText(findTestObject('Login/username'), usernameAppr1)
...
WebUI.click(findTestObject('Object Repository/Overcredit/Amendment agr trf approval/select_role_seh'))
WebUI.delay(1)
