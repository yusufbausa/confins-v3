...
//WebUI.selectOptionByIndex(findTestObject('REMEDIAL/Remedial Activity/Additional Item/select_collection_bucket_name'), 1)
//WebUI.click(findTestObject('REMEDIAL/Remedial Activity/button_search'))
//	if (WebUI.verifyElementVisible(findTestObject('REMEDIAL/Remedial Activity/button_action'), FailureHandling.CONTINUE_ON_FAILURE)) {
//			WebUI.click(findTestObject('REMEDIAL/Remedial Activity/button_action'))
...
//	} else {
////			WebUI.click(findTestObject('REMEDIAL/Remedial Activity/button_action'))
////			WebUI.click(findTestObject('REMEDIAL/Remedial Activity/Additional Item/select_collection_bucket_name'))
//			WebUI.selectOptionByIndex(findTestObject('REMEDIAL/Remedial Activity/Additional Item/select_collection_bucket_name'), 2)
//			WebUI.click(findTestObject('REMEDIAL/Remedial Activity/button_search'))
//			WebUI.delay(1)
//			WebUI.click(findTestObject('REMEDIAL/Remedial Activity/button_action'))
