...
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Asset to Pool/Confirm Asset to Pool/select_collection_group'), 30)
WebUI.verifyElementPresent(findTestObject('REMEDIAL/Asset to Pool/Confirm Asset to Pool/select_collection_group'), 30)
WebUI.verifyElementClickable(findTestObject('REMEDIAL/Asset to Pool/Confirm Asset to Pool/select_collection_group'))
WebUI.selectOptionByValue(findTestObject('REMEDIAL/Asset to Pool/Confirm Asset to Pool/select_collection_group'), '31', false)
...
WebUI.delay(1)
WebUI.setText(findTestObject('COLLECTION/Confirm Asset to Pool/field_receive_by'), receivedBy)
