...
//input credential
WebUI.setText(findTestObject('Login/username'), usernameRisk)
WebUI.setText(findTestObject('Login/password'), password)
WebUI.click(findTestObject('Login/btn_login'))
//WebUI.delay(1)


//select menu rem deal amount approval (Things To Do)
WebUI.click(findTestObject('Object Repository/REMEDIAL/Remedial Deal Amount/Remedial Deal Amount Approval Risk/menu_rem_deal_amt_approval'))
WebUI.delay(1)
