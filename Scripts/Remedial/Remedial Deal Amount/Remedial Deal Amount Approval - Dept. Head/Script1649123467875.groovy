...
//input credential
WebUI.setText(findTestObject('Login/username'), usernameDH)
...
//select role
WebUI.click(findTestObject('Object Repository/REMEDIAL/Remedial Deal Amount/Remedial Deal Amount Approval/select_role - dept. head'))
...
WebUI.click(findTestObject('Object Repository/REMEDIAL/Remedial Deal Amount/Remedial Deal Amount Request/expand_menu_rem_deal_amount - appr dept head'))
