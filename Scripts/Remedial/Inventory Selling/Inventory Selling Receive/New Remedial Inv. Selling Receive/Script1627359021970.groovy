...
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_agreement_number'), 
    20)
WebUI.setText(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_agreement_number'), '1962105269')
...
WebUI.waitForElementPresent(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_received_from'), 
    20)
WebUI.setText(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_received_from'), 'Bachtera')
WebUI.setText(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_reference_no'), '123456789')
...
WebUI.selectOptionByValue(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/select_bank_account'), '10', 
    false)
WebUI.setText(findTestObject('REMEDIAL/Inventory Selling/Inventory Selling Receive/field_value_date'), '13/07/2021')
