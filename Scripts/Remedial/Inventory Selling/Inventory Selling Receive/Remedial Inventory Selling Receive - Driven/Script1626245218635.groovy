...
WebUI.waitForElementPresent(findTestObject('COLLECTION/Inventory Selling/Inventory Selling Receive/New Folder/button_menu'), 20)
WebUI.verifyElementPresent(findTestObject('COLLECTION/Inventory Selling/Inventory Selling Receive/New Folder/button_menu'), 2)
WebUI.delay(1)
//WebUI.click(findTestObject('COLLETION/Inventory Selling/Inventory Selling Receive/button_menu'))
