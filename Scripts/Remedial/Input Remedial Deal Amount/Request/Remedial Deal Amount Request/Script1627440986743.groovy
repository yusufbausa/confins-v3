...
WebUI.sendKeys(findTestObject('REMEDIAL/Input Remedial Deal Amount/Request/field_agreement_number'), '1917822384')
...
WebUI.sendKeys(findTestObject('REMEDIAL/Input Remedial Deal Amount/Request/field_deal_amount'), '150000000')
WebUI.delay(1)
...
WebUI.setText(findTestObject('REMEDIAL/Input Remedial Deal Amount/Request/field_effective_date'), '13/06/2021')
