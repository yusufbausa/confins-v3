...
WebUI.waitForElementPresent(findTestObject('Object Repository/COPY CANCEL/Copy Cancelled Application/input_Application No._ucSearchtxtAppNo_ltlAppAppNoSearch'), 20)
