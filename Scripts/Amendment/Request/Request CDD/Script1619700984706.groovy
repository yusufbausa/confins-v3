...
//REQUEST CDD PROCESS================================================================================================================================================================================================================================================================================================================
WebUI.sendKeys(findTestObject('Object Repository/Amendment/Request/CDD/input_New Due Date_ucdpNewDueDttxtDatePicker'),
	Keys.chord(Keys.CONTROL + "a"))
WebUI.sendKeys(findTestObject('Object Repository/Amendment/Request/CDD/input_New Due Date_ucdpNewDueDttxtDatePicker'),
Keys.chord(Keys.DELETE))
WebUI.sendKeys(findTestObject('Object Repository/Amendment/Request/CDD/input_New Due Date_ucdpNewDueDttxtDatePicker'), '10/04/2021')
WebUI.click(findTestObject('Object Repository/Amendment/Request/CDD/input_Value must be Date Format_lb_Form_Calculate'))
WebUI.delay(5)
WebUI.scrollToElement(findTestObject('Amendment/Request/CDD/select_Select OneCustomer Request'), 0)
WebUI.selectOptionByValue(findTestObject('Object Repository/Amendment/Request/CDD/select_Select OneCustomer Request'), '87', 
    false)
WebUI.selectOptionByValue(findTestObject('Object Repository/Amendment/Request/CDD/select_Select OneLFC2023SUG0793WYU0489'), 
    '305222', false)
